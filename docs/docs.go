    ...
    "paths": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/model.AliasResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/aliases/anonymous": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Anonymous alias submission",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.AnonymousAliasRequest"
                        }
                    }
                ],
                "responses": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/model.RegionResponse"
                                            }
                                        }
                                    }
                                }
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "format": "int64",
                        "description": "Root region ID (optional)",
                        "name": "root_id",
                        "in": "query"
                    }
                ],
    ...
    "definitions": {
        ...
        "model.AliasRequest": {
            ...
            "properties": {
                ...
                "name_type": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/model.NameType"
                        }
                    ]
                },
                "region_id": {
        ...
        "model.AliasResponse": {
            ...
            "properties": {
                ...
                "status": {
                    "$ref": "#/definitions/model.AliasStatus"
                },
                "submitted_by": {
                    "type": "integer"
                },
        ...
        "model.RegionResponse": {
            ...
            "properties": {
                ...
                "region_type": {
                    "$ref": "#/definitions/model.RegionType"
                },
                "sort_order": {
                    "type": "integer"
                }
