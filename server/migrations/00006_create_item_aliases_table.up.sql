...
CREATE INDEX idx_aliases_region_code ON item_aliases(region_code);
CREATE INDEX idx_aliases_status ON item_aliases(status);
CREATE INDEX idx_aliases_submitter_slug ON item_aliases(submitter_slug);
CREATE INDEX idx_aliases_reviewer_slug ON item_aliases(reviewer_slug);
